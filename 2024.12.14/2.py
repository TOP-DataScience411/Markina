...
def load_data() -> None:
    ...
    """
    path = Path(r'C:\Users\Админ\Scripts\Markina\2024.12.14\data\names')
...
# 'фамилия': 'Руденко',
# 'пол': 'мужской',
# 'дата рождения': datetime.date(2005, 3, 23),
# 'мобильный': '+79691459958'}
#>>> pprint(generate_person(), sort_dicts=False)
#{'имя': 'Феоктиста',
# 'отчество': 'Ароновна',
# 'фамилия': 'Даль',
# 'пол': 'женский',
# 'дата рождения': datetime.date(1927, 12, 29),
# 'мобильный': '+79430782696'}
#>>>